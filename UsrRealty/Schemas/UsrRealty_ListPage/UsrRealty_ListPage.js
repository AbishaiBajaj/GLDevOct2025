define("UsrRealty_ListPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"columns": [
						...
						{
							"id": "b608d3ec-28ef-06a9-791c-4bf38ffac43e",
							"code": "PDS_UsrPrice",
							"caption": "#ResourceString(PDS_UsrPrice)#",
							"dataValueType": 32
						},
						{
							"id": "00d9eccf-ddb0-802b-1c8f-42291515758a",
							"code": "PDS_UsrType",
							"caption": "#ResourceString(PDS_UsrType)#",
							"dataValueType": 10
						},
						{
							"id": "3249da4d-e70a-e273-01b7-22354e4ceb6f",
							"code": "PDS_UsrOfferType",
							"caption": "#ResourceString(PDS_UsrOfferType)#",
							"dataValueType": 10
						},
						{
							"id": "8d1a9e36-2e29-a92c-6572-479dd12cf309",
							"code": "PDS_CreatedOn",
			...
			{
				"operation": "insert",
				"name": "QuickFilter_9lhgrpz",
				"values": {
					"type": "crt.QuickFilter",
					"config": {
						"caption": "#ResourceString(QuickFilter_9lhgrpz_config_caption)#",
						"hint": "",
					...
					"_filterOptions": {
						"expose": [
							{
								"attribute": "QuickFilter_9lhgrpz_Items",
								"converters": [
									{
						...
						"from": "QuickFilter_9lhgrpz_Value"
					},
					"filterType": "lookup"
				},
			...
			},
			{
				...
				"values": {
					"filterAttributes": [
						...
						{
							"name": "QuickFilter_9lhgrpz_Items",
							"loadOnChange": true
						}
					]
				}
